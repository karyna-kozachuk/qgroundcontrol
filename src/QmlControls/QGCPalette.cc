...
void QGCPalette::_buildMap()
{
    ...
    //                                              Disabled    Enabled
    DECLARE_QGC_NONTHEMED_COLOR(brandingPurple,     "#6d2c2c", "#6d2c2c")
    DECLARE_QGC_NONTHEMED_COLOR(brandingBlue,       "#67ff48", "#4fc545")
    DECLARE_QGC_NONTHEMED_COLOR(toolStripFGColor,   "#4b3848", "#e1df28")
